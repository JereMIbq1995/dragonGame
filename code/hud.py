...
class HUD():
    def __init__(self,windowWidth,windowHeight,warriorTypes):
        ...
        self._setUpTypes()
        self._lastTypePosition = (self._types[-1].center_x, self._types[-1].center_y)
    ...
    def _setUpTypes(self):
        ...
        for warriorId in self._warriorTypes:
            ...
            self._types.append(warriorType)
            index += 1
    ...
    def getWarrior(self,mouseX,mouseY):
        ...
        for sprite in self._types:
            if sprite.collides_with_point((mouseX,mouseY)):
                ...
                self._lastSelectedPosition = (self._types[i].center_x, self._types[i].center_y)
                self._types.pop(i)
